...
$cadenaAgregarQuitar="<a href='agregacarContrato.php?SID&id=".$filas['idproductos']."'>
<img src='../imagenes/productonoagregado.gif' border='0' title='Agregar al Carrito'></a>'";
		}else{
$cadenaAgregarQuitar="<a href='borracarContrato.php?SID&id=".$filas['idproductos']."'>
<img src='../imagenes/trash.gif' border='0' title='Agregar al Carrito'></a>'";		
	}
		echo"Nombre:".$filas['codigo_producto']."<br>
		Descripcion:".limitarPalabras($filas['descripcion_producto'],20)."<br>
		Precio:".$filas['precio']."<br>Stock:".$filas['Cantidad_producto'].$cadenaAgregarQuitar."<br>";}
}
?>

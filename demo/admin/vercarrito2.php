...
<?php 
 ...
 $contador++; 
 ?> 
 <form name="a<?php echo $v['identificador'] ?>" method="post" action="agregacarBoleta.php?<?php echo SID ?>" id="a<?php echo $v['identificador'] ?>"> 
 ...
 <td align="center"><a href="borracarBoleta.php?<?php echo SID ?>&id=<?php echo $v['idproductos'] ?>"><img src="../imagenes/trash.gif" width="12" height="14" border="0"></a></td> 
 <td align="center"> 
...
<div align="center"><span class="prod">Continuar la selección de productos</span> 
 <a href="catalogo2.php?<?php echo SID;?>"><img src="../imagenes/continuar.gif" width="13" height="13" border="0" align="absmiddle"></a>&nbsp; 
...
<?php }else{ ?> 
<p align="center"> <span class="prod">No hay productos seleccionados</span> <a href="catalogo2.php?<?php echo SID;?>"><img src="../imagenes/actualizar.gif" width="13" height="13" border="0"></a> 
 <?php }?> 
</p> 
<form name="formularioGuardar" action="registrandoBoleta.php" method="post">
<input type="hidden" name="tipoDocumento" value="2">
